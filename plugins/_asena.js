...
const Lang = Language.getString('_slandroid');

if (Config.WORKTYPE == 'private') {

    Asena.addCommand({pattern: 'slandroid ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'slandroid ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
